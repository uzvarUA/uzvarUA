...
На Android 17 (майбутня версія) **Google посилює захист від зловживань** у Developer Options:

- **[Таймери очікування](ca://s?q=Android_Developer_Options_wait_timers)** — це штучні затримки, щоб користувач не міг постійно перемикати «номер збірки» чи інші критичні параметри.
- **7 хвилин / 24 години** — ймовірно, це нова політика безпеки, яка:
  - обмежує частоту активації режиму розробника;
  - запобігає автоматизації чи скриптам, що намагаються «форсувати» включення;
  - зменшує ризик для користувачів, які випадково активують небезпечні опції.

Тобто це **не баг**, а **захист від зловживань**. На Galaxy A04e чи Pixus Arena ви можете зіткнутися з цим, якщо часто перемикаєте Developer Options.

---

## 🔑 Висновок
- Для Android 17 — затримки у Developer Options потрібні, щоб **знизити ризик неконтрольованих змін системи**.
...
| я | U+044F | \u044F |
___
Можемо підійти з двох боків — зробити таблицю порівняння утиліт із F-Droid або скласти чекліст базового захисту Android. Ось як це виглядатиме:

---

📊 Таблиця порівняння F-Droid утиліт

| Утиліта | Функція | Особливості | Рівень складності |
|-------------|-------------|-----------------|-----------------------|
| Hypatia | Антивірусний сканер | Відкритий код, простий інтерфейс | Легкий |
| ClassyShark3xodus | Аналіз APK | Показує трекери та бібліотеки | Середній |
| VirusTotal Mobile | Перевірка APK | Використовує хмарний сервіс VirusTotal | Легкий |
| AFWall+ | Фаєрвол | Контроль доступу додатків до інтернету | Складний (потрібен root) |
| NetGuard | Блокування інтернету | Працює без root, простий контроль | Легкий |

---

✅ Чекліст базового захисту Android

- Оновлення системи — регулярно встановлюй патчі безпеки.  
- Перевірка APK — використовуй VirusTotal Mobile або ClassyShark3xodus.  
- Фаєрвол — NetGuard чи AFWall+ для контролю доступу до мережі.  
- Антивірусний сканер — Hypatia для базової перевірки.  
- Менеджер дозволів — регулярно перевіряй, які права мають додатки.  
- Резервні копії — зберігай важливі дані у хмарі чи на SD-карті.  
- F-Droid замість Play Store — для відкритих і прозорих додатків без реклами.  

---



# 📊 AQI для PM2.5 — Шпаргалка
...
- **I** — AQI для PM2.5  
- **C** — виміряна концентрація (μg/m³)  
- **C_low, C_high** — межі концентрації для діапазону  
- **I_low, I_high** — межі AQI для цього діапазону  

---

## Таблиця діапазонів (EPA, США)

| Концентрація PM2.5 (μg/m³) | AQI | Категорія |
|-----------------------------|-----|-----------|
| 0.0 – 12.0                 | 0 – 50   | Гарна |
| 12.1 – 35.4                | 51 – 100 | Нормальна |
| 35.5 – 55.4                | 101 – 150 | Нездорова для чутливих |
| 55.5 – 150.4               | 151 – 200 | Нездорова |
| 150.5 – 250.4              | 201 – 300 | Дуже нездорова |
| 250.5 – 500.4              | 301 – 500 | Небезпечна |

---

## Приклад розрахунку
- **C = 40 μg/m³**  
- Діапазон: 35.5–55.4 μg/m³ → AQI 101–150  
- Розрахунок:  
\[
I = \frac{(150 - 101)}{(55.4 - 35.5)} \cdot (40 - 35.5) + 101 \approx 112
\]

👉 AQI ≈ **112** → «Нездорова для чутливих груп»

# /e/os
/e/OS (раніше відомий як eelo) - це **безкоштовна, відкрита операційна система, яка базується на Android, але не містить вбудованого програмного забезпечення від Google.** 
\
Ось ключові характеристики та переваги /e/OS:
\
* **Без Google:** Найбільша перевага - відсутність Google Services (Google Play Store, Gmail, Maps, YouTube тощо). Це робить її привабливою для людей, які хочуть мати більше контролю над своїми даними та не хочуть бути підключеними до екосистеми Google.
\
* **Відкритий код:**  Код операційної системи відкритий, що дозволяє перевіряти його на безпеку та вносити зміни.
* **Безпека та конфіденційність:** /e/OS акцентує увагу на конфіденційності та безпеці користувачів.  Він має вбудовані функції безпеки, щоб захистити ваші дані.
* **Сумісність з Android:**  Він сумісний з багатьма телефонами, які раніше працювали на Android. 
* **Активна спільнота:**  Має активну спільноту користувачів, які надають підтримку та розробляють нові функції.
* **Простота використання:**  Операційна система має інтерфейс, який дуже схожий на стандартний Android, тому перехід на неї не повинен бути складним.
* **Без реклами:**  Він не містить реклами.
\
**Кому це може бути цікаво?**

*   **Людям, які піклуються про конфіденційність:**  Якщо ви хочете уникнути відстеження Google та контролю над вашими даними, /e/OS може бути хорошим варіантом.
*   **Технологічно підкованим користувачам:**  Якщо ви хочете мати більший контроль над своїм телефоном і бажаєте експериментувати з операційною системою, /e/OS може бути цікавим.
*   **Людям, які хочуть уникнути вбудованого програмного забезпечення Google:**  Якщо ви не хочете використовувати Google Play Store та інші Google сервіси, /e/OS надає альтернативу.
\
**Важливо знати:**
\
...
### 1. Встановлення MLC Chat
- Завантажте APK з [офіційного GitHub MLC AI Releases](https://github.com/mlc-ai/mlc-llm/releases).
- Увімкніть дозвіл на встановлення з «невідомих джерел».
- Встановіть додаток вручну.

### 2. Завантаження моделі
- Перейдіть на [Hugging Face](https://huggingface.co/models) та знайдіть модель у форматі **GGUF**.
- Для Galaxy A04e обирайте моделі **2–3B параметрів** (Saiga‑2B, Gemma‑2‑2B‑it).
- Для Pixus Arena можна пробувати моделі до **7B параметрів** (Gemma‑2‑7B‑Q4_K).

### 3. Розміщення файлу
- Створіть папку `MLC/models` у внутрішній пам’яті телефону.
- Скопіюйте туди `.gguf` файл.
- Переконайтеся, що назва файлу проста (без пробілів чи спецсимволів).

### 4. Додавання моделі у MLC Chat
- Запустіть MLC Chat.
- У меню моделей оберіть **“Add local model”**.
- Вкажіть шлях до вашого файлу.
- Модель з’явиться у списку — можна почати чат офлайн.

---

## ⚠️ Поради
- Galaxy A04e: швидкість ~2–3 токени/секунду, контекст 512–1024.
- Pixus Arena: витягує до 2048 токенів, швидкість вища.
- Використовуйте **Q4_K або Q6_K** квантовані моделі для економії пам’яті.
- Тримайте мінімум 25% вільного сховища для стабільної роботи.

---

## 📌 Чек‑лист
- [x] Завантажити APK MLC Chat  
- [x] Завантажити GGUF‑модель з Hugging Face  
- [x] Скопіювати у `MLC/models`  
- [x] Додати модель у додатку  
- [x] Запустити чат офлайн
# 📥 Оффлайн ШІ на Android

Цей README допоможе швидко встановити та оптимізувати офлайн‑ШІ клієнти на Galaxy A04e та Pixus Arena.
...
### 1. MLC Chat
- [GitHub Releases](https://github.com/mlc-ai/mlc-llm/releases)
- Підтримка GGUF‑моделей (Saiga‑2B, Gemma‑2‑2B‑it, Qwen‑RuAdapt).

### 2. ChatterUI
- [GitHub Releases](https://github.com/chatterui/chatterui/releases)
- Мінімалістичний клієнт для запуску моделей у форматі GGUF.

### 3. Google AI Edge Gallery
- [Play Store](https://play.google.com/store/apps/details?id=com.google.ai.edge.gallery)
- Офіційний додаток для запуску моделей Gemma, LLaMA, Phi локально.

---

## ⚙️ Встановлення

1. Завантажити APK з офіційних джерел.
2. Увімкнути **«Дозволити встановлення з невідомих джерел»** у налаштуваннях Android.
3. Встановити додаток.
4. Завантажити потрібні моделі у форматі **GGUF**.

---

## 📊 Оптимізація під слабкі телефони

### Galaxy A04e
- Використовувати моделі до **2–3B параметрів**.
- Формат: `q4f16` (квантізація для економії пам’яті).
- Контекст: ≤ 2048 токенів.

### Pixus Arena
- Тягне моделі до **7B параметрів**.
- Можна ставити більш «важкі» моделі (LLaMA‑3B, Gemma‑2B).
- Контекст: до 4096 токенів.

---

## ✅ Рекомендовані українські моделі
- **Saiga‑2B** — україномовний чат.
- **Gemma‑2‑2B‑it** — багатомовна підтримка, включно з українською.
- **Qwen‑RuAdapt** — адаптована для слов’янських мов.

---

## 🔒 Поради з безпеки
- Завантажуйте APK лише з офіційних GitHub/Play Store.
- Перевіряйте цифрові підписи.
- Використовуйте офлайн‑режим для приватності.

# Зробити власний «навігатор» на базі Organic Maps і RHVoice можна так:

🛠️ Основна ідея
Organic Maps вже вміє озвучувати маршрути через системний TTS. RHVoice — це рушій синтезу мовлення, який додає українські голоси. Тобто ти поєднуєш їх: Organic Maps генерує текстові інструкції, а RHVoice їх озвучує.

📋 Кроки налаштування
1. Встанови RHVoice з F-Droid.  
   - Після інсталяції зайди в Android → Налаштування → Мова та введення → Вивід тексту в мову (TTS).  
   - Обери RHVoice як основний рушій.
2. У RHVoice завантаж українські голоси (наприклад, Наталя чи Андрій).  
   - Це робиться всередині додатку RHVoice.
3. У Organic Maps увімкни голосові підказки:  
   - Налаштування → Голосові підказки → вибери системний TTS.  
   - Тепер маршрути будуть озвучуватись голосом RHVoice.
4. Перевір роботу: проклади маршрут і переконайся, що інструкції звучать українською.

___
Всім привіт! Давно з вами не спілкувався, навіть дуже сильно скучив за форматом подкастів, але хочу розповісти про кумедну ситуацію на майданчику, платформі YouTube. І чому я, ви мабуть помітили, перестав публікувати посилання на завантаження тих чи інших програм на прямі джерела. Я більше не робив цього в описі під відео, а залишав у коментарі й, грубо кажучи, пропускаю вас через фільтр **Blogger**. Тобто ви переходите на **Blogger**, а вже там у мене опубліковані посилання на завантаження програм. І насправді я отримую хейт навіть від підписників, які стежать за моїм каналом 10–11 років, що я чиню некрасиво. Але чому я так почав робити? Давайте трохи поясню.<br>

От тільки що я переписувався з підтримкою YouTube — знову прилетів страйк за порушення правил. Є така програма ADB Run. Я нею користуюся, це моя улюблена й найпростіша утиліта для відладки смартфона через режим **ADB**. Вона працює на Windows 11, автор її перестав розвивати років 5–6 тому, але головне, що вона й досі працює й мене як користувача повністю влаштовує. Я знімав детальний відеоогляд, як нею користуватися, як робити повний бекап телефону. І, звісно, залишив у описі посилання на офіційний сайт розробника.<br>

Але тепер цей сайт AndroidP1.ru перетворився на ресурс MostBad — казино чи щось подібне. Я до азартних ігор не маю жодного відношення, завжди казав, що на моєму каналі ніколи не буде реклами казино чи банків. І виходить так, що я у своєму ролику відправляю людей качати програму, а фактично перенаправляю їх на сайт казино. Це жорстке порушення правил YouTube.<br>

Я пояснюю підтримці: ролик був опублікований 7 років тому, тоді сайт був іншим. Зараз він казино, але я фізично не можу відстежувати всі старі посилання — у мене понад 2000 відео. Вони відповідають, що автор несе повну відповідальність за всі опубліковані посилання. Тобто я сам винен, що не помітив, як за останні роки сайт перепродали власнику казино. Це вже не перший випадок, тому я й почав публікувати посилання через **Blogger**. Бо що б там не сталося, **Blogger** ніколи не перетвориться на казино чи сайт з вірусами. І коли перевірятимуть посилання, що веде на Blogger, порушень правил YouTube не знайдуть. А вже там я спокійно можу розміщувати будь-які джерела.<br>

Зараз у мене висить одне порушення. А ви знаєте, як працює YouTube: три страйки — і канал безапеляційно видаляють. Якби я не був партнером YouTube, то вже нічого не зміг би зробити. Партнерка зараз дає лише можливість у спірних ситуаціях написати напряму менеджеру підтримки. У більшості авторів такої можливості немає.

До речі, напишіть, чи скучили ви за подкастами. Я навіть зроблю опитування. Бо сам дуже скучив. Скоро вийде кілька роликів про ігри, ми з моєю подругою вже починаємо стрімити — купили стримерську деку, мікрофон, ігри для кооперативу. Хочу повернутися до формату подкастів, особливо наших «посиденьок у Minecraft: Bedrock Edition». Хто пам’ятає, що таке «Minecraft», обов’язково відмітьте у голосуванні.<br>

Всім гарного настрою! Побачимось!
___
 ***Я користуюсь застосунком Notely Voice: AI Voice to Text*** <br>
...
- [Анджеліна Джолі перемогла Бреда Пітта](https://fakty.ua/471445-andzhelina-dzholi-pobedila-breda-pitta)
